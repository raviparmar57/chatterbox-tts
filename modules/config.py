...
# Add src directory to path for chatterbox imports
...
LANGUAGE_CONFIG = {
    ...
    "en": {"audio": "https://storage.googleapis.com/chatterbox-demo-samples/mtl_prompts/en_f1.flac", "text": "Hey there! I'm The Oracle Guy, and I'm unlocking the secrets of AI! Subscribe now and join the AI revolution!"},
